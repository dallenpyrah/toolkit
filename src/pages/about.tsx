      ...
      <main className="flex flex-col min-h-screen bg-gradient-to-b from-black to-gray-900">
        ...
        <div className="flex flex-col items-center justify-center flex-1 px-4 py-12 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl px-5 mt-10 font-extrabold tracking-tight text-gray-50 sm:text-5xl md:text-6xl">
            ...
            <div className="mt-10  space-y-10">
              <div>
                <h2 className="text-2xl font-bold text-gray-50 mb-10 px-5">Founder</h2>
              ...
              <div>
                <h2 className="text-2xl font-bold text-gray-50 mb-8 px-5">Open Source - Open Mind</h2>
                <p className="mt-2 text-gray-500 px-5">
              ...
              <div>
                <h2 className="text-2xl font-bold text-gray-50 mb-8 px-5">Why We&apos;re Doing It</h2>
                <p className="mt-2 text-gray-500 px-5">
